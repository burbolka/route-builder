...
namespace RouteBuilder.Common.Interfaces.Services
{
    ...
    public interface IDroneFinder
    {
        ...
        /// <summary>
        /// The get drone fleets async.
        /// </summary>
        /// <returns>
        /// The <see cref="Task"/>.
        /// </returns>
        Task<IEnumerable<IAddressItem>> GetDroneFleetsAsync();

        /// <summary>
        /// The get available drones async.
        /// </summary>
        /// <returns>
        /// The <see cref="Task"/>.
        /// </returns>
        Task<IEnumerable<IAddressItem>> GetAvailableDronesAsync();
    }
}
